            ...
            brandsSlider.each(function () {
                ...
                if (self.not('.slick-initialized')) {
                    self.slick({
                        ...
                        prevArrow: '<a class="prev-arrow"><i class="far fa-long-arrow-alt-right"></i></a>',
                        nextArrow: '<a class="next-arrow"><i class="far fa-long-arrow-alt-left"></i></a>',
                        responsive: [{
                                breakpoint: 1200,
                                settings: {
                                    slidesToShow: 4,
    ...
    QuoteStyle4: function () {
      ...
      QSlider4.each(function () {
        QSlider4.slick({             
          ...
          arrows: true,       
          appendArrows: '.quotes-arrow-nav',
          prevArrow: '<a class="prev-arrow"><i class="fas fa-long-arrow-alt-left"></i></a>',
          nextArrow: '<a class="next-arrow"><i class="fas fa-long-arrow-alt-right"></i></a>',
          responsive: [
            {
              breakpoint: 992,
              settings: {
